...
const flowResourceMessages = {
  en: {
    ...
    builder: {
      ...
      title: 'Flow Builder',
      subtitle: 'Create, tune, and reorder the sections that make up this Pomodoro flow.',
      loading: 'Loading flow builder...',
      addSection: 'Add Section',
      addFirstSection: 'Add First Section',
      emptyTitle: 'No sections yet',
      emptySubtitle: 'Build your first study session.',
      sectionTitle: 'Section {number}',
      nodeTitle: 'Title',
      nodeTitlePlaceholder: 'Name this section',
      titleDialog: {
        eyebrow: 'New section',
        title: 'Choose a title for this section',
      ...
      saved: 'Saved',
      blankSummary: 'A blank ritual ready for its first intentional block.',
      activeSummary: 'Designed as a calm sequence of attention, recovery, and completion.',
      sectionSingular: 'Section',
      sectionPlural: 'Sections',
      meta: '{sections} {sectionLabel} • {minutes} min total • Ends around {completion}',
      minutes: '{count} min',
      minutesShort: '{count}m',
      minuteShort: 'min',
      overviewLabel: 'Flow overview',
      journeyPreview: 'Journey Preview',
      segmentTitle: '{title} • {minutes} min',
      segmentLegend: '{title} · {minutes}m',
      emptyBuilderHint: 'Create your first block to start shaping the rhythm of this flow.',
      endsWith: 'Ends with',
      stats: {
        totalDuration: 'Total Duration',
        sections: 'Sections',
        longestSession: 'Longest Session',
        averageBlock: 'Average Block',
      },
      cardSubtitles: {
        focus: 'Move through focused attention',
        relax: 'Recover, reset, and soften',
        sleep: 'Settle into deep calm',
      },
      nodeSuggestions: {
        ...
        concentrationBlock: 'Concentration Block',
        shortBreak: 'Short Break',
        recoveryBreak: 'Recovery Break',
        mentalReset: 'Mental Reset',
        longBreak: 'Long Break',
        quickRecharge: 'Quick Recharge',
        pause: 'Pause',
        powerNap: 'Power Nap',
        recoveryNap: 'Recovery Nap',
        restBlock: 'Rest Block',
        sleepReset: 'Sleep Reset',
        deepRest: 'Deep Rest',
        relaxationSession: 'Relaxation Session',
        breathingSession: 'Breathing Session',
        calmSession: 'Calm Session',
        mindfulSession: 'Mindful Session',
        unwindSession: 'Unwind Session',
        attentionExercise: 'Attention Exercise',
        reflectionExercise: 'Reflection Exercise',
        mindfulFocus: 'Mindful Focus',
        journaling: 'Journaling',
        clarityPractice: 'Clarity Practice',
        sleepPreparation: 'Sleep Preparation',
        windDown: 'Wind Down',
        nightRoutine: 'Night Routine',
        sleepTransition: 'Sleep Transition',
        eveningReset: 'Evening Reset',
        sleepPhase: 'Sleep Phase',
        sleepCycle: 'Sleep Cycle',
        nightPhase: 'Night Phase',
        deepSleepBlock: 'Deep Sleep Block',
        restPhase: 'Rest Phase',
        relaxationPhase: 'Relaxation Phase',
        bodyRelaxation: 'Body Relaxation',
        breathingPhase: 'Breathing Phase',
        mentalClearing: 'Mental Clearing',
        reflection: 'Reflection',
        brainDump: 'Brain Dump',
        mindReset: 'Mind Reset',
      ...
      duration: 'Duration',
      endAlarm: 'End Alarm',
      alarmPlaceholder: 'Choose an alarm',
      noAlarm: 'No alarm',
      deleteSection: 'Delete section',
      saving: 'Saving...',
      confirmDeleteSection: 'Delete this flow section?',
      errors: {
        load: 'Unable to load the flow builder.',
        create: 'Unable to create this section.',
        update: 'Unable to save this section.',
        delete: 'Unable to delete this section.',
        reorder: 'Unable to save the section order.',
        noModes: 'Create at least one non-system mode before adding sections.',
        noAlarms: 'Create at least one Session Alarm audio before adding sections.',
      },
    },
    create: {
      eyebrow: 'New flow',
  ...
  ja: {
    ...
    builder: {
      eyebrow: 'フロービルダー',
      title: 'フロービルダー',
      subtitle: 'このポモドーロフローを構成するセクションを作成、調整、並べ替えます。',
      loading: 'フロービルダーを読み込み中...',
      addSection: 'セクションを追加',
      addFirstSection: '最初のセクションを追加',
      emptyTitle: 'まだセクションがありません',
      emptySubtitle: '最初の学習セッションを作りましょう。',
      sectionTitle: 'セクション {number}',
      nodeTitle: 'タイトル',
      nodeTitlePlaceholder: 'このセクションに名前を付ける',
      titleDialog: {
        eyebrow: '新しいセクション',
        title: 'このセクションのタイトルを選択',
        suggestions: '候補',
        custom: 'カスタム',
        customPlaceholder: 'カスタムタイトルを入力...',
        create: 'セクションを作成',
      },
      saved: '保存済み',
      blankSummary: '最初の意図的なブロックを待つ空のリチュアルです。',
      activeSummary: '集中、回復、完了を穏やかにつなぐ流れです。',
      sectionSingular: 'セクション',
      sectionPlural: 'セクション',
      meta: '{sections} {sectionLabel} • 合計 {minutes} 分 • {completion} ごろ終了',
      minutes: '{count} 分',
      minutesShort: '{count}分',
      minuteShort: '分',
      overviewLabel: 'フロー概要',
      journeyPreview: 'ジャーニープレビュー',
      segmentTitle: '{title} • {minutes} 分',
      segmentLegend: '{title} · {minutes}分',
      emptyBuilderHint: '最初のブロックを作成して、このフローのリズムを形にしましょう。',
      endsWith: '終了音',
      stats: {
        totalDuration: '合計時間',
        sections: 'セクション',
      ...
      cardSubtitles: {
        focus: '集中した注意で進みます',
        relax: '回復し、リセットし、ゆるめます',
        sleep: '深い落ち着きに入ります',
      },
      nodeSuggestions: {
        studySession: '学習セッション',
        focusSession: '集中セッション',
        deepWorkSession: 'ディープワークセッション',
        learningBlock: '学習ブロック',
        concentrationBlock: '集中ブロック',
        shortBreak: '短い休憩',
        recoveryBreak: '回復休憩',
        mentalReset: 'メンタルリセット',
        longBreak: '長めの休憩',
        quickRecharge: '短い充電',
        pause: '一時停止',
        powerNap: 'パワーナップ',
        ...
        sleepReset: '睡眠リセット',
        deepRest: '深い休息',
        relaxationSession: 'リラックスセッション',
        breathingSession: '呼吸セッション',
        calmSession: '穏やかなセッション',
        mindfulSession: 'マインドフルセッション',
        unwindSession: 'くつろぎセッション',
        attentionExercise: '注意のエクササイズ',
        reflectionExercise: '内省エクササイズ',
        mindfulFocus: 'マインドフル集中',
        journaling: 'ジャーナリング',
        clarityPractice: '明晰さの練習',
        sleepPreparation: '睡眠準備',
        windDown: 'クールダウン',
        nightRoutine: '夜のルーティン',
        sleepTransition: '睡眠への移行',
        eveningReset: '夜のリセット',
        sleepPhase: '睡眠フェーズ',
        sleepCycle: '睡眠サイクル',
        nightPhase: '夜のフェーズ',
        deepSleepBlock: '深い睡眠ブロック',
        restPhase: '休息フェーズ',
        relaxationPhase: 'リラックスフェーズ',
        bodyRelaxation: '身体のリラックス',
        breathingPhase: '呼吸フェーズ',
        mentalClearing: '思考のクリアリング',
        reflection: '内省',
        brainDump: 'ブレインダンプ',
        mindReset: '思考リセット',
        thoughtRelease: '思考の解放',
      },
      dragHandle: 'セクションをドラッグ',
      mode: 'モード',
      modePlaceholder: 'モードを選択',
      duration: '時間',
      endAlarm: '終了アラーム',
      alarmPlaceholder: 'アラームを選択',
      noAlarm: 'アラームなし',
      deleteSection: 'セクションを削除',
      saving: '保存中...',
      confirmDeleteSection: 'このフローセクションを削除しますか？',
      errors: {
        load: 'フロービルダーを読み込めません。',
        create: 'このセクションを作成できません。',
        update: 'このセクションを保存できません。',
        delete: 'このセクションを削除できません。',
        reorder: 'セクションの順序を保存できません。',
        noModes: 'セクションを追加する前に、システム以外のモードを少なくとも1つ作成してください。',
        noAlarms: 'セクションを追加する前に、Session Alarm の音源を少なくとも1つ作成してください。',
      },
    },
    create: {
      eyebrow: '新しいフロー',
  ...
  ptBR: {
    ...
    builder: {
      eyebrow: 'Flow builder',
      title: 'Flow Builder',
      subtitle: 'Crie, ajuste e reordene as seções que formam este flow Pomodoro.',
      loading: 'Carregando flow builder...',
      addSection: 'Adicionar seção',
      addFirstSection: 'Adicionar primeira seção',
      emptyTitle: 'Nenhuma seção ainda',
      emptySubtitle: 'Monte sua primeira sessão de estudo.',
      sectionTitle: 'Seção {number}',
      nodeTitle: 'Título',
      nodeTitlePlaceholder: 'Nomeie esta seção',
      titleDialog: {
        eyebrow: 'Nova seção',
        title: 'Escolha um título para esta seção',
        suggestions: 'Sugestões',
        custom: 'Personalizado',
        customPlaceholder: 'Digite um título personalizado...',
        create: 'Criar seção',
      },
      saved: 'Salvo',
      blankSummary: 'Um ritual em branco pronto para o primeiro bloco intencional.',
      activeSummary: 'Criado como uma sequência calma de atenção, recuperação e conclusão.',
      sectionSingular: 'Seção',
      sectionPlural: 'Seções',
      meta: '{sections} {sectionLabel} • {minutes} min no total • Termina por volta de {completion}',
      minutes: '{count} min',
      minutesShort: '{count}m',
      minuteShort: 'min',
      overviewLabel: 'Resumo do flow',
      journeyPreview: 'Prévia da jornada',
      segmentTitle: '{title} • {minutes} min',
      segmentLegend: '{title} · {minutes}m',
      emptyBuilderHint: 'Crie seu primeiro bloco para começar a moldar o ritmo deste flow.',
      endsWith: 'Termina com',
      stats: {
        totalDuration: 'Duração total',
        sections: 'Seções',
        longestSession: 'Sessão mais longa',
        averageBlock: 'Bloco médio',
      },
      cardSubtitles: {
        focus: 'Avance com atenção focada',
        relax: 'Recupere, redefina e suavize',
        sleep: 'Entre em calma profunda',
      },
      nodeSuggestions: {
        studySession: 'Sessão de estudo',
        focusSession: 'Sessão de foco',
        deepWorkSession: 'Sessão de trabalho',
        learningBlock: 'Bloco de aprendizado',
        concentrationBlock: 'Bloco de concentração',
        shortBreak: 'Pausa curta',
        recoveryBreak: 'Pausa de recuperação',
        mentalReset: 'Reset mental',
        longBreak: 'Pausa longa',
        quickRecharge: 'Recarga rápida',
        pause: 'Pausa',
        powerNap: 'Cochilo rápido',
        recoveryNap: 'Cochilo de recuperação',
        restBlock: 'Bloco de descanso',
        sleepReset: 'Reset de sono',
        deepRest: 'Descanso profundo',
        relaxationSession: 'Sessão de relaxamento',
        breathingSession: 'Sessão de respiração',
        calmSession: 'Sessão calma',
        mindfulSession: 'Sessão mindful',
        unwindSession: 'Sessão para desacelerar',
        attentionExercise: 'Exercício de atenção',
        reflectionExercise: 'Exercício de reflexão',
        mindfulFocus: 'Foco mindful',
        journaling: 'Journaling',
        clarityPractice: 'Prática de clareza',
        sleepPreparation: 'Preparação para dormir',
        windDown: 'Desacelerar',
        nightRoutine: 'Rotina noturna',
        sleepTransition: 'Transição para o sono',
        eveningReset: 'Reset da noite',
        sleepPhase: 'Fase do sono',
        sleepCycle: 'Ciclo de sono',
        nightPhase: 'Fase noturna',
        deepSleepBlock: 'Bloco de sono profundo',
        restPhase: 'Fase de descanso',
        relaxationPhase: 'Fase de relaxamento',
        bodyRelaxation: 'Relaxamento corporal',
        breathingPhase: 'Fase de respiração',
        mentalClearing: 'Limpeza mental',
        reflection: 'Reflexão',
        brainDump: 'Despejo mental',
        mindReset: 'Reset da mente',
        thoughtRelease: 'Liberação de pensamentos',
      },
      dragHandle: 'Arrastar seção',
      mode: 'Modo',
      modePlaceholder: 'Escolha um modo',
      duration: 'Duração',
      endAlarm: 'Alarme final',
      alarmPlaceholder: 'Escolha um alarme',
      noAlarm: 'Sem alarme',
      deleteSection: 'Excluir seção',
      saving: 'Salvando...',
      confirmDeleteSection: 'Excluir esta seção do flow?',
      errors: {
        load: 'Não foi possível carregar o flow builder.',
        create: 'Não foi possível criar esta seção.',
        update: 'Não foi possível salvar esta seção.',
        delete: 'Não foi possível excluir esta seção.',
        reorder: 'Não foi possível salvar a ordem das seções.',
        noModes: 'Crie pelo menos um modo que não seja do sistema antes de adicionar seções.',
        noAlarms: 'Crie pelo menos um áudio de Session Alarm antes de adicionar seções.',
      },
    },
    create: {
      eyebrow: 'Novo flow',
  ...
  es: {
    ...
    builder: {
      eyebrow: 'Flow builder',
      title: 'Flow Builder',
      subtitle: 'Crea, ajusta y reordena las secciones que forman este flow Pomodoro.',
      loading: 'Cargando flow builder...',
      addSection: 'Agregar sección',
      addFirstSection: 'Agregar primera sección',
      emptyTitle: 'Aún no hay secciones',
      emptySubtitle: 'Construye tu primera sesión de estudio.',
      sectionTitle: 'Sección {number}',
      nodeTitle: 'Título',
      nodeTitlePlaceholder: 'Nombra esta sección',
      titleDialog: {
        eyebrow: 'Nueva sección',
        title: 'Elige un título para esta sección',
        suggestions: 'Sugerencias',
        custom: 'Personalizado',
        customPlaceholder: 'Ingresa un título personalizado...',
        create: 'Crear sección',
      },
      saved: 'Guardado',
      blankSummary: 'Un ritual en blanco listo para su primer bloque intencional.',
      activeSummary: 'Diseñado como una secuencia tranquila de atención, recuperación y cierre.',
      sectionSingular: 'Sección',
      sectionPlural: 'Secciones',
      meta: '{sections} {sectionLabel} • {minutes} min en total • Termina alrededor de {completion}',
      minutes: '{count} min',
      minutesShort: '{count}m',
      minuteShort: 'min',
      overviewLabel: 'Resumen del flow',
      journeyPreview: 'Vista previa del recorrido',
      segmentTitle: '{title} • {minutes} min',
      segmentLegend: '{title} · {minutes}m',
      emptyBuilderHint: 'Crea tu primer bloque para empezar a dar forma al ritmo de este flow.',
      endsWith: 'Termina con',
      stats: {
        totalDuration: 'Duración total',
        sections: 'Secciones',
        longestSession: 'Sesión más larga',
        averageBlock: 'Bloque promedio',
      },
      cardSubtitles: {
        focus: 'Avanza con atención enfocada',
        relax: 'Recupérate, reinicia y suaviza',
        sleep: 'Entra en calma profunda',
      },
      nodeSuggestions: {
        studySession: 'Sesión de estudio',
        focusSession: 'Sesión de foco',
        deepWorkSession: 'Sesión de deep work',
        learningBlock: 'Bloque de aprendizaje',
        concentrationBlock: 'Bloque de concentración',
        shortBreak: 'Pausa corta',
        recoveryBreak: 'Pausa de recuperación',
        mentalReset: 'Reinicio mental',
        longBreak: 'Pausa larga',
        quickRecharge: 'Recarga rápida',
        pause: 'Pausa',
        powerNap: 'Siesta rápida',
        recoveryNap: 'Siesta de recuperación',
        restBlock: 'Bloque de descanso',
        sleepReset: 'Reinicio de sueño',
        deepRest: 'Descanso profundo',
        relaxationSession: 'Sesión de relajación',
        breathingSession: 'Sesión de respiración',
        calmSession: 'Sesión de calma',
        mindfulSession: 'Sesión mindful',
        unwindSession: 'Sesión para desconectar',
        attentionExercise: 'Ejercicio de atención',
        reflectionExercise: 'Ejercicio de reflexión',
        mindfulFocus: 'Foco mindful',
        journaling: 'Journaling',
        clarityPractice: 'Práctica de claridad',
        sleepPreparation: 'Preparación para dormir',
        windDown: 'Desconexión gradual',
        nightRoutine: 'Rutina nocturna',
        sleepTransition: 'Transición al sueño',
        eveningReset: 'Reinicio nocturno',
        sleepPhase: 'Fase de sueño',
        sleepCycle: 'Ciclo de sueño',
        nightPhase: 'Fase nocturna',
        deepSleepBlock: 'Bloque de sueño profundo',
        restPhase: 'Fase de descanso',
        relaxationPhase: 'Fase de relajación',
        bodyRelaxation: 'Relajación corporal',
        breathingPhase: 'Fase de respiración',
        mentalClearing: 'Limpieza mental',
        reflection: 'Reflexión',
        brainDump: 'Descarga mental',
        mindReset: 'Reinicio mental',
        thoughtRelease: 'Liberación de pensamientos',
      },
      dragHandle: 'Arrastrar sección',
      mode: 'Modo',
      modePlaceholder: 'Elige un modo',
      duration: 'Duración',
      endAlarm: 'Alarma final',
      alarmPlaceholder: 'Elige una alarma',
      noAlarm: 'Sin alarma',
      deleteSection: 'Eliminar sección',
      saving: 'Guardando...',
      confirmDeleteSection: '¿Eliminar esta sección del flow?',
      errors: {
        load: 'No se pudo cargar el flow builder.',
        create: 'No se pudo crear esta sección.',
        update: 'No se pudo guardar esta sección.',
        delete: 'No se pudo eliminar esta sección.',
        reorder: 'No se pudo guardar el orden de las secciones.',
        noModes: 'Crea al menos un modo que no sea del sistema antes de agregar secciones.',
        noAlarms: 'Crea al menos un audio de Session Alarm antes de agregar secciones.',
      },
    },
    create: {
      eyebrow: 'Nuevo flow',
...
const coreTimerMessages = {
  en: {
    ...
    flow: {
      selectLabel: 'Current flow',
      selectPlaceholder: 'Select a flow',
      defaultMode: 'Default Pomodoro',
      loading: 'Loading flow...',
      progress: '{completed} / {total} sections completed',
      activeSection: 'Section {current} of {total}: {title}',
      completedSections: 'Sections completed',
      currentSection: 'Section',
      completeTitle: 'Flow complete',
      completedSubtitle: 'Great work. You completed {flow}.',
      restartFlow: 'Restart flow',
      loadAnother: 'Load another flow',
      returnDefault: 'Return to default',
      emptyTitle: 'This flow has no sections yet.',
      emptyBody: 'Add sections in the Flow Builder before running it here.',
      editFlow: 'Edit flow',
      noAlarm: 'No flow alarm',
      triggerEyebrow: 'Choose Flow',
      chooseFlow: 'Choose Flow',
      pickerEyebrow: 'Journey selection',
      pickerTitle: 'Choose your next flow',
      noFlows: 'No flows available yet.',
      sectionCount: '{count} sections',
      durationHoursMinutes: '{hours}h {minutes}m',
      durationHours: '{hours}h',
      sectionsLabel: 'Sections',
      durationLabel: 'Duration',
      previewTimeline: 'Journey preview',
      ...
      descriptions: {
        focus: 'Prepare for intensive study sessions with structured recovery moments.',
        creative: 'Move through open thinking, creation, and gentle resets.',
        deep: 'A quiet protocol for sustained attention and deliberate breaks.',
        sleep: 'A gradual descent through low-stimulation stages for restorative sleep.',
        relax: 'Ease into calmer rhythms with soft pauses and spacious transitions.',
      },
      nextJourney: 'Your next {duration} journey',
      journeyMap: 'Journey Map',
      startPoint: 'Start',
      finishPoint: 'Finish',
      energySignature: 'Energy Signature',
      howItFeels: 'Journey Signature',
      metricsLabel: 'Journey metrics',
      expectedOutcome: 'Expected Outcome',
      forecastTitle: 'Session forecast',
      nodeRoles: {
        focus: 'Focus Sprint',
        recovery: 'Recovery',
        sleep: 'Sleep Stage',
        creative: 'Creative Lift',
      },
      metrics: {
        focusCycles: 'Focus Cycles',
        recoveryMoments: 'Recovery Moments',
        totalDuration: 'Total Duration',
        focusRatio: 'Focus Ratio',
        cognitiveIntensity: 'Cognitive Intensity',
      },
      intensity: {
        high: 'High',
        moderate: 'Moderate',
      ...
      narratives: {
        focus:
          'You will enter {cycles} structured focus cycles over {duration}, separated by {recoveries} strategic recovery moments.',
        sleep:
          'A gradual descent into restorative sleep stages designed to reduce mental stimulation.',
        relax:
          'A balanced sequence of decompression and recovery designed to lower cognitive load.',
        creative:
          'An open-ended creative arc that alternates generative momentum with light cognitive resets.',
      },
      forecasts: {
        language: [
        ...
        focus: [
          ...
          'Cleaner recovery between cycles',
        ],
        relax: [
          'Lower cognitive load',
          'Smoother decompression',
          'Reduced mental friction',
          'Steadier recovery rhythm',
        ],
        sleep: [
          'Reduced stimulation',
          'Faster sleep onset',
        ...
        creative: [
          ...
          'Looser association',
          'Gentle momentum',
          'Lower creative resistance',
        ],
      },
      cta: {
        focus: 'Begin Focus Journey',
        relax: 'Start Recovery Session',
        sleep: 'Enter Sleep Protocol',
        creative: 'Open Creative Flow',
      },
    },
    audio: {
      eyebrow: 'Mode music',
      ...
      volume: 'Volume',
      panelLabel: 'Session audio panel',
    },
    environment: {
      eyebrow: 'Audio worlds',
      title: 'Choose Your Cognitive Environment',
      subtitle: 'Each environment shapes how your journey feels.',
      close: 'Close environment explorer',
      catalogLabel: 'Cognitive environments',
      searchLabel: 'Search audio environments',
      searchPlaceholder: 'Search audio or mode',
      addYoutube: 'Add from YouTube',
      addYoutubeCopy: 'Paste a video link and preview it here.',
      youtubeSource: 'YouTube',
      youtubeBadge: 'YouTube preview',
      youtubeInputLabel: 'YouTube link',
      youtubePlaceholder: 'https://www.youtube.com/watch?v=...',
      youtubeHint: 'Visible YouTube player only. Playlists are not supported.',
      youtubeInvalid: 'Paste a valid YouTube video link.',
      youtubePreviewUnavailable: 'This video cannot be embedded or played here.',
      youtubeAutoplayBlocked:
        'Press Start again or use the visible YouTube player to allow playback.',
      youtubePlayerError: 'Unable to play this YouTube video.',
      youtubeBuffering: 'Buffering',
      youtubePreviewLabel: 'YouTube preview player',
      youtubeActiveLabel: 'Active YouTube session player',
      current: 'Current',
      currentlySelected: 'Currently selected',
      previewing: 'Previewing',
      useAudio: 'Use This Audio',
      useYoutube: 'Use This YouTube Audio',
      removeYoutube: 'Remove {title}',
      noMatching: 'No matching audio',
      currentEnvironment: 'Current Environment',
      browseAction: 'Change Music',
    },
    ...
    actions: {
      ...
      expandMusicPanel: 'Expand session audio panel',
      collapseMusicPanel: 'Collapse session audio panel',
  ...
  ja: {
    ...
    flow: {
      selectLabel: '現在のフロー',
      selectPlaceholder: 'フローを選択',
      defaultMode: 'デフォルトポモドーロ',
      loading: 'フローを読み込み中...',
      progress: '{completed} / {total} セクション完了',
      activeSection: 'セクション {current} / {total}: {title}',
      completedSections: '完了セクション',
      currentSection: 'セクション',
      completeTitle: 'フロー完了',
      completedSubtitle: 'お疲れさまです。{flow} を完了しました。',
      restartFlow: 'フローを再開',
      loadAnother: '別のフローを読み込む',
      returnDefault: 'デフォルトに戻る',
      emptyTitle: 'このフローにはまだセクションがありません。',
      emptyBody: 'ここで実行する前に Flow Builder でセクションを追加してください。',
      editFlow: 'フローを編集',
      noAlarm: 'フローアラームなし',
      triggerEyebrow: 'フローを選ぶ',
      chooseFlow: 'フローを選ぶ',
      pickerEyebrow: 'ジャーニー選択',
      pickerTitle: '次のフローを選択',
      noFlows: '利用できるフローはまだありません。',
      sectionCount: '{count} セクション',
      durationHoursMinutes: '{hours}時間 {minutes}分',
      durationHours: '{hours}時間',
      sectionsLabel: 'セクション',
      durationLabel: '時間',
      previewTimeline: 'ジャーニープレビュー',
      startJourney: 'ジャーニーを開始',
      identities: {
        focus: 'フォーカス主導',
        creative: 'クリエイティブフロー',
        deep: 'ディープワーク',
      ...
      descriptions: {
        focus: '集中的な学習セッションと構造化された回復時間に備えます。',
        creative: '自由な思考、制作、やさしいリセットを流れるように進みます。',
        deep: '持続的な注意と意図的な休憩のための静かなプロトコルです。',
        sleep: '回復的な睡眠へ向けて刺激を抑えながら段階的に降りていきます。',
        relax: '穏やかな休憩と余白のある移行で落ち着いたリズムへ入ります。',
      },
      nextJourney: '次の {duration} ジャーニー',
      journeyMap: 'ジャーニーマップ',
      startPoint: '開始',
      finishPoint: '完了',
      energySignature: 'エネルギーシグネチャ',
      howItFeels: 'ジャーニーシグネチャ',
      metricsLabel: 'ジャーニーメトリクス',
      expectedOutcome: '期待される成果',
      forecastTitle: 'セッション予測',
      nodeRoles: {
        focus: 'フォーカススプリント',
        recovery: '回復',
        sleep: '睡眠ステージ',
      ...
      metrics: {
        focusCycles: 'フォーカスサイクル',
        recoveryMoments: '回復ポイント',
        totalDuration: '合計時間',
        focusRatio: 'フォーカス比率',
        cognitiveIntensity: '認知強度',
      },
      intensity: {
        high: '高',
        moderate: '中',
      ...
      narratives: {
        focus:
          '{duration} の中で {cycles} 個の構造化されたフォーカスサイクルに入り、{recoveries} 個の戦略的な回復時間で区切ります。',
        sleep: '精神的な刺激を減らすために設計された、回復的な睡眠ステージへのゆるやかな下降です。',
        relax: '認知負荷を下げるための、解放と回復のバランスが取れたシーケンスです。',
        creative: '生成的な勢いと軽い認知リセットを交互に進む、開かれたクリエイティブアークです。',
      },
      forecasts: {
        language: ['語彙保持', 'リスニング練習', '疲労軽減', '長時間集中'],
        focus: ['拡張された集中', '文脈切り替えの減少', 'タスク完了率の向上', 'サイクル間の回復'],
        relax: ['認知負荷の低下', 'なめらかな減圧', '精神的摩擦の低下', '安定した回復リズム'],
        sleep: ['刺激の低下', '入眠しやすさ', '回復の向上', '穏やかな夜への移行'],
        creative: ['アイデア生成', '連想の広がり', 'やさしい勢い', '創造的抵抗の低下'],
      },
      cta: {
        focus: 'フォーカスジャーニーを開始',
        relax: '回復セッションを開始',
        sleep: '睡眠プロトコルに入る',
        creative: 'クリエイティブフローを開く',
      },
    },
    audio: {
      eyebrow: 'モード音楽',
      ...
      progress: '音源の進行',
      volume: '音量',
      panelLabel: 'セッション音声パネル',
    },
    environment: {
      eyebrow: 'オーディオワールド',
      title: '認知環境を選択',
      subtitle: '環境ごとに、セッションの感じ方が変わります。',
      close: '環境選択を閉じる',
      catalogLabel: '認知環境',
      searchLabel: '音源環境を検索',
      searchPlaceholder: '音源またはモードを検索',
      addYoutube: 'YouTubeから追加',
      addYoutubeCopy: '動画リンクを貼り付けてプレビューします。',
      youtubeSource: 'YouTube',
      youtubeBadge: 'YouTubeプレビュー',
      youtubeInputLabel: 'YouTubeリンク',
      youtubePlaceholder: 'https://www.youtube.com/watch?v=...',
      youtubeHint: '表示されるYouTubeプレイヤーのみ使用します。プレイリストは未対応です。',
      youtubeInvalid: '有効なYouTube動画リンクを貼り付けてください。',
      youtubePreviewUnavailable: 'この動画はここで埋め込み再生できません。',
      youtubeAutoplayBlocked:
        'もう一度開始するか、表示中のYouTubeプレイヤーで再生を許可してください。',
      youtubePlayerError: 'このYouTube動画を再生できません。',
      youtubeBuffering: 'バッファ中',
      youtubePreviewLabel: 'YouTubeプレビュープレイヤー',
      youtubeActiveLabel: 'セッション用YouTubeプレイヤー',
      current: '現在',
      currentlySelected: '現在選択中',
      previewing: 'プレビュー中',
      useAudio: 'この音源を使う',
      useYoutube: 'このYouTube音源を使う',
      removeYoutube: '{title} を削除',
      noMatching: '一致する音源がありません',
    ...
    actions: {
      ...
      expandMusicPanel: 'セッション音声パネルを展開',
      collapseMusicPanel: 'セッション音声パネルを折りたたむ',
  ...
  ptBR: {
    ...
    flow: {
      selectLabel: 'Flow atual',
      selectPlaceholder: 'Selecionar um flow',
      defaultMode: 'Pomodoro padrão',
      loading: 'Carregando flow...',
      progress: '{completed} / {total} seções concluídas',
      activeSection: 'Seção {current} de {total}: {title}',
      completedSections: 'Seções concluídas',
      currentSection: 'Seção',
      completeTitle: 'Flow completo',
      completedSubtitle: 'Ótimo trabalho. Você concluiu {flow}.',
      restartFlow: 'Reiniciar flow',
      loadAnother: 'Carregar outro flow',
      returnDefault: 'Voltar ao padrão',
      emptyTitle: 'Este flow ainda não tem seções.',
      emptyBody: 'Adicione seções no Flow Builder antes de executá-lo aqui.',
      editFlow: 'Editar flow',
      noAlarm: 'Sem alarme do flow',
      triggerEyebrow: 'Escolher flow',
      chooseFlow: 'Escolher flow',
      pickerEyebrow: 'Seleção de jornada',
      pickerTitle: 'Escolha seu próximo flow',
      noFlows: 'Ainda não há flows disponíveis.',
      sectionCount: '{count} seções',
      durationHoursMinutes: '{hours}h {minutes}m',
      durationHours: '{hours}h',
      sectionsLabel: 'Seções',
      durationLabel: 'Duração',
      previewTimeline: 'Prévia da jornada',
      startJourney: 'Iniciar jornada',
      identities: {
        focus: 'Guiado por foco',
        creative: 'Flow criativo',
        deep: 'Deep work',
        sleep: 'Protocolo de sono',
        relax: 'Guiado por recuperação',
      },
      descriptions: {
        focus:
          'Prepare-se para sessões intensas de estudo com momentos estruturados de recuperação.',
        creative: 'Avance por pensamento aberto, criação e reinícios leves.',
        deep: 'Um protocolo silencioso para atenção sustentada e pausas deliberadas.',
        sleep: 'Uma descida gradual por estágios de baixa estimulação para sono restaurador.',
        relax: 'Entre em ritmos mais calmos com pausas suaves e transições espaçosas.',
      },
      nextJourney: 'Sua próxima jornada de {duration}',
      journeyMap: 'Mapa da jornada',
      startPoint: 'Início',
      finishPoint: 'Fim',
      energySignature: 'Assinatura de energia',
      howItFeels: 'Assinatura da jornada',
      metricsLabel: 'Métricas da jornada',
      expectedOutcome: 'Resultado esperado',
      forecastTitle: 'Previsão da sessão',
      nodeRoles: {
        focus: 'Sprint de foco',
        recovery: 'Recuperação',
        sleep: 'Estágio de sono',
        creative: 'Impulso criativo',
      },
      metrics: {
        focusCycles: 'Ciclos de foco',
        recoveryMoments: 'Momentos de recuperação',
        totalDuration: 'Duração total',
        focusRatio: 'Proporção de foco',
        cognitiveIntensity: 'Intensidade cognitiva',
      },
      intensity: {
        high: 'Alta',
        moderate: 'Moderada',
      ...
      narratives: {
        focus:
          'Você entrará em {cycles} ciclos estruturados de foco ao longo de {duration}, separados por {recoveries} momentos estratégicos de recuperação.',
        sleep:
          'Uma descida gradual para estágios de sono restaurador desenhados para reduzir a estimulação mental.',
        relax:
          'Uma sequência equilibrada de descompressão e recuperação desenhada para reduzir a carga cognitiva.',
        creative:
          'Um arco criativo aberto que alterna impulso generativo com reinícios cognitivos leves.',
      },
      forecasts: {
        language: [
        ...
        focus: [
          ...
          'Mais conclusão de tarefas',
          'Recuperação mais limpa entre ciclos',
        ],
        relax: [
          'Menor carga cognitiva',
          'Descompressão mais suave',
          'Menos atrito mental',
          'Ritmo de recuperação mais estável',
        ],
        sleep: [
          'Menos estimulação',
          'Início de sono mais rápido',
          'Melhor recuperação',
          'Transição noturna mais calma',
        ],
        creative: [
          'Geração de ideias',
          'Associação mais livre',
          'Impulso gentil',
          'Menos resistência criativa',
        ],
      },
      cta: {
        focus: 'Iniciar jornada de foco',
        relax: 'Iniciar sessão de recuperação',
        sleep: 'Entrar no protocolo de sono',
        creative: 'Abrir flow criativo',
      },
    },
    audio: {
      ...
      volume: 'Volume',
      panelLabel: 'Painel de áudio da sessão',
    },
    environment: {
      eyebrow: 'Mundos de áudio',
      title: 'Escolha seu ambiente cognitivo',
      subtitle: 'Cada ambiente molda como sua jornada se sente.',
      close: 'Fechar seletor de ambiente',
      catalogLabel: 'Ambientes cognitivos',
      searchLabel: 'Buscar ambientes de áudio',
      searchPlaceholder: 'Buscar áudio ou modo',
      addYoutube: 'Adicionar do YouTube',
      addYoutubeCopy: 'Cole um link de vídeo e pré-visualize aqui.',
      youtubeSource: 'YouTube',
      youtubeBadge: 'Prévia do YouTube',
      youtubeInputLabel: 'Link do YouTube',
      youtubePlaceholder: 'https://www.youtube.com/watch?v=...',
      youtubeHint: 'Somente player visível do YouTube. Playlists não são suportadas.',
      youtubeInvalid: 'Cole um link válido de vídeo do YouTube.',
      youtubePreviewUnavailable: 'Este vídeo não pode ser incorporado ou reproduzido aqui.',
      youtubeAutoplayBlocked:
        'Pressione Iniciar novamente ou use o player visível do YouTube para permitir a reprodução.',
      youtubePlayerError: 'Não foi possível reproduzir este vídeo do YouTube.',
      youtubeBuffering: 'Carregando',
      youtubePreviewLabel: 'Player de prévia do YouTube',
      youtubeActiveLabel: 'Player YouTube ativo da sessão',
      current: 'Atual',
      currentlySelected: 'Selecionado agora',
      previewing: 'Pré-visualizando',
      useAudio: 'Usar este áudio',
      useYoutube: 'Usar este áudio do YouTube',
      removeYoutube: 'Remover {title}',
      noMatching: 'Nenhum áudio encontrado',
      currentEnvironment: 'Ambiente atual',
      browseAction: 'Trocar música',
    },
    ...
    actions: {
      ...
      expandMusicPanel: 'Expandir painel de áudio da sessão',
      collapseMusicPanel: 'Recolher painel de áudio da sessão',
  ...
  es: {
    ...
    flow: {
      selectLabel: 'Flow actual',
      selectPlaceholder: 'Seleccionar un flow',
      defaultMode: 'Pomodoro predeterminado',
      loading: 'Cargando flow...',
      progress: '{completed} / {total} secciones completadas',
      activeSection: 'Sección {current} de {total}: {title}',
      completedSections: 'Secciones completadas',
      currentSection: 'Sección',
      completeTitle: 'Flow completo',
      completedSubtitle: 'Buen trabajo. Completaste {flow}.',
      restartFlow: 'Reiniciar flow',
      loadAnother: 'Cargar otro flow',
      returnDefault: 'Volver al modo predeterminado',
      emptyTitle: 'Este flow aún no tiene secciones.',
      emptyBody: 'Agrega secciones en Flow Builder antes de ejecutarlo aquí.',
      editFlow: 'Editar flow',
      noAlarm: 'Sin alarma del flow',
      triggerEyebrow: 'Elegir flow',
      chooseFlow: 'Elegir flow',
      pickerEyebrow: 'Selección de jornada',
      pickerTitle: 'Elige tu próximo flow',
      noFlows: 'Aún no hay flows disponibles.',
      sectionCount: '{count} secciones',
      durationHoursMinutes: '{hours}h {minutes}m',
      durationHours: '{hours}h',
      sectionsLabel: 'Secciones',
      durationLabel: 'Duración',
      previewTimeline: 'Vista de la jornada',
      startJourney: 'Iniciar jornada',
      identities: {
        focus: 'Guiado por foco',
        creative: 'Flow creativo',
        deep: 'Deep work',
        sleep: 'Protocolo de sueño',
        relax: 'Guiado por recuperación',
      },
      descriptions: {
        focus:
          'Prepárate para sesiones intensas de estudio con momentos estructurados de recuperación.',
        creative: 'Avanza entre pensamiento abierto, creación y reinicios suaves.',
        deep: 'Un protocolo silencioso para atención sostenida y pausas deliberadas.',
        sleep: 'Un descenso gradual por etapas de baja estimulación para un sueño reparador.',
        relax: 'Entra en ritmos más tranquilos con pausas suaves y transiciones amplias.',
      },
      nextJourney: 'Tu próxima jornada de {duration}',
      journeyMap: 'Mapa de la jornada',
      startPoint: 'Inicio',
      finishPoint: 'Final',
      energySignature: 'Firma de energía',
      howItFeels: 'Firma de la jornada',
      metricsLabel: 'Métricas de la jornada',
      expectedOutcome: 'Resultado esperado',
      forecastTitle: 'Previsión de la sesión',
      nodeRoles: {
        focus: 'Sprint de foco',
        recovery: 'Recuperación',
        sleep: 'Etapa de sueño',
        creative: 'Impulso creativo',
      },
      metrics: {
        focusCycles: 'Ciclos de foco',
        recoveryMoments: 'Momentos de recuperación',
        totalDuration: 'Duración total',
        focusRatio: 'Proporción de foco',
        cognitiveIntensity: 'Intensidad cognitiva',
      },
      intensity: {
        high: 'Alta',
        moderate: 'Moderada',
      ...
      narratives: {
        focus:
          'Entrarás en {cycles} ciclos estructurados de foco durante {duration}, separados por {recoveries} momentos estratégicos de recuperación.',
        sleep:
          'Un descenso gradual hacia etapas de sueño reparador diseñadas para reducir la estimulación mental.',
        relax:
          'Una secuencia equilibrada de descompresión y recuperación diseñada para reducir la carga cognitiva.',
        creative:
          'Un arco creativo abierto que alterna impulso generativo con reinicios cognitivos ligeros.',
      },
      forecasts: {
        language: [
        ...
        focus: [
          ...
          'Mayor finalización de tareas',
          'Recuperación más limpia entre ciclos',
        ],
        relax: [
          'Menor carga cognitiva',
          'Descompresión más suave',
          'Menos fricción mental',
          'Ritmo de recuperación más estable',
        ],
        sleep: [
          'Menos estimulación',
          'Inicio de sueño más rápido',
          'Mejor recuperación',
          'Transición nocturna más calma',
        ],
        creative: [
          'Generación de ideas',
          'Asociación más libre',
          'Impulso suave',
          'Menos resistencia creativa',
        ],
      },
      cta: {
        focus: 'Iniciar jornada de foco',
        relax: 'Iniciar sesión de recuperación',
        sleep: 'Entrar al protocolo de sueño',
        creative: 'Abrir flow creativo',
      },
    },
    audio: {
      ...
      volume: 'Volumen',
      panelLabel: 'Panel de audio de la sesión',
    },
    environment: {
      eyebrow: 'Mundos de audio',
      title: 'Elige tu entorno cognitivo',
      subtitle: 'Cada entorno moldea cómo se siente tu sesión.',
      close: 'Cerrar selector de entorno',
      catalogLabel: 'Entornos cognitivos',
      searchLabel: 'Buscar entornos de audio',
      searchPlaceholder: 'Buscar audio o modo',
      addYoutube: 'Agregar desde YouTube',
      addYoutubeCopy: 'Pega un enlace de video y previsualízalo aquí.',
      youtubeSource: 'YouTube',
      youtubeBadge: 'Vista previa de YouTube',
      youtubeInputLabel: 'Enlace de YouTube',
      youtubePlaceholder: 'https://www.youtube.com/watch?v=...',
      youtubeHint: 'Solo reproductor visible de YouTube. No se admiten playlists.',
      youtubeInvalid: 'Pega un enlace válido de video de YouTube.',
      youtubePreviewUnavailable: 'Este video no se puede insertar o reproducir aquí.',
      youtubeAutoplayBlocked:
        'Presiona Iniciar otra vez o usa el reproductor visible de YouTube para permitir la reproducción.',
      youtubePlayerError: 'No se pudo reproducir este video de YouTube.',
      youtubeBuffering: 'Cargando',
      youtubePreviewLabel: 'Reproductor de vista previa de YouTube',
      youtubeActiveLabel: 'Reproductor YouTube activo de la sesión',
      current: 'Actual',
      currentlySelected: 'Seleccionado ahora',
      previewing: 'Vista previa',
      useAudio: 'Usar este audio',
      useYoutube: 'Usar este audio de YouTube',
      removeYoutube: 'Quitar {title}',
      noMatching: 'No hay audio coincidente',
      currentEnvironment: 'Entorno actual',
      browseAction: 'Cambiar música',
    },
    ...
    actions: {
      ...
      expandMusicPanel: 'Expandir panel de audio de la sesión',
      collapseMusicPanel: 'Contraer panel de audio de la sesión',
