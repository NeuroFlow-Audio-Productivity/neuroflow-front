  ...
  en: {
    ...
    api: {
      ...
      errors: {
        ...
        credentials: 'Unable to sign in with these credentials.',
  ...
  ja: {
    ...
    api: {
      ...
      errors: {
        ...
        credentials: 'この認証情報ではサインインできません。',
  ...
  ptBR: {
    ...
    api: {
      ...
      errors: {
        ...
        credentials: 'Não foi possível entrar com essas credenciais.',
  ...
  es: {
    ...
    api: {
      ...
      errors: {
        ...
        credentials: 'No se pudo entrar con estas credenciales.',
